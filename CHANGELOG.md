...
- b67a96a: Replace the legacy template system with a versioned blueprint pipeline shared by the CLI, Nx generators, and MCP server.
...
- 945b2ee: fix: centralize naming conventions and fix linter false positives
...
- f4d4e7f: Comprehensive type safety improvements for Effect templates
...
- fbf863a: Fix catchTags type inference for Effect error channels
