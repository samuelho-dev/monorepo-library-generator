 ...
 * Pubsub Redis Layer
 *
 * Redis-backed distributed pub/sub layer using provider-redis.
 ...
 *
 * @module @samuelho-dev/infra-pubsub/layers/redis
 ...
 * @example
 * ```typescript
 * import { PubsubService, PubsubRedisLayer } from "@samuelho-dev/infra-pubsub";
 * import { Redis } from "@samuelho-dev/provider-redis";
