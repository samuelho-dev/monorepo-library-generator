...
Integrates with infrastructure services (Logging, Metrics) and data-access layer.`,
  ...
  builder.addImports([
    { from: "effect", imports: ["Context", "Effect", "Layer"], isTypeOnly: false }
  ])
  builder.addImports([
    { from: "effect", imports: ["Option"], isTypeOnly: true }
  ])
  ...
  builder.addImports([
    { from: `${scope}/contract-${parentFileName}/${subModuleName}`, imports: [`${subModuleClassName}OperationError`] },
    {
  ...
  builder.addImports([
    { from: `${scope}/data-access-${parentFileName}/${subModuleName}`, imports: [`${subModuleClassName}Repository`] }
  ])
