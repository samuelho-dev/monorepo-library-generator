/**
 * Contract Auth Errors Template
 *
 * Generates lib/errors.ts for contract-auth library.
 * Defines auth-related errors using Schema.TaggedError for RPC serialization.
 *
 ...
 *
 * Errors defined:
 * - AuthError: User authentication failures
 * - ServiceAuthError: Service-to-service auth failures
 */
export function generateAuthErrorsFile(options: AuthTemplateOptions) {
