...
describe('provider generator', () => {
  ...
  describe('📁 File Generation Tests', () => {
    it('should generate all required files for server-only provider', async () => {
      ...
      expect(tree.exists(`${projectRoot}/src/lib/service/service.ts`)).toBeTruthy();
  ...
  describe('📝 Template Content Tests', () => {
    it('should use Context.Tag pattern in service interface', async () => {
      ...
      // New granular structure: service/service.ts
      const serviceContent = tree.read('libs/provider/stripe/src/lib/service/service.ts', 'utf-8');
    ...
    it('should include all Layer types in layers.ts', async () => {
      ...
      const layersContent = tree.read('libs/provider/stripe/src/lib/layers.ts', 'utf-8');
    ...
    it('should generate service interface correctly', async () => {
      ...
      const serviceContent = tree.read(
        'libs/provider/analytics/src/lib/service/service.ts',
        'utf-8',
      );
  ...
  describe('🎯 Naming Convention Tests', () => {
    it('should use correct naming transformations', async () => {
      ...
      const serviceContent = tree.read(
        'libs/provider/my-custom-service/src/lib/service/service.ts',
        'utf-8',
      );
