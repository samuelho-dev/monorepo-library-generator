/**
 * OpenTelemetry Provider Templates - Export Index
 *
 * Specialized templates for the OpenTelemetry provider library.
 * Generates the OTEL SDK provider that integrates Effect with OpenTelemetry.
 *
