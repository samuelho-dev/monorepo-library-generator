/**
 * Redis PubSub Sub-Service Template
 *
 * Generates the pub/sub operations sub-service for the Redis provider.
 * Implements the RedisPubSubClient interface expected by infra-pubsub.
 *
 ...
 */
export function generateRedisPubSubServiceFile(options: ProviderTemplateOptions) {
...
Used by infra-pubsub's Redis layer.`,
    module: `${packageName}/service/pubsub`
  })
