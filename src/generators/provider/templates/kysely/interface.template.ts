/**
 * Kysely Provider Interface Template
 *
 * Generates the service interface for the Kysely database query builder.
 * Generic over DB type for type-safe database access.
 *
 ...
 */
export function generateKyselyInterfaceFile(options: ProviderTemplateOptions) {
 ...
 * \`\`\`
 */
export interface ${className}ServiceInterface<DB> {
  /**
