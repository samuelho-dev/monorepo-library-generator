  ...
  try {
    ...
    for (const line of content.split("\n")) {
      ...
      vars.push({
        ...
        isPublic,
        isSecret,
        context: isPublic ? "client" : (name === "NODE_ENV" ? "shared" : "server"),
...
export function getDefaultEnvVars(): Array<ParsedEnvVar> {
  return [
    ...
    { name: "PORT", type: "number", isPublic: false, isSecret: false, context: "server", hasDefault: "3000" },
    ...
    { name: "EFFECT_CACHE_API_KEY", type: "string", isPublic: false, isSecret: true, context: "server" },
    { name: "EFFECT_CACHE_TIMEOUT", type: "number", isPublic: false, isSecret: false, context: "server" },
    { name: "EFFECT_LOGGER_API_KEY", type: "string", isPublic: false, isSecret: true, context: "server" },
    { name: "EFFECT_LOGGER_TIMEOUT", type: "number", isPublic: false, isSecret: false, context: "server" },
    { name: "EFFECT_METRICS_API_KEY", type: "string", isPublic: false, isSecret: true, context: "server" },
    { name: "EFFECT_METRICS_TIMEOUT", type: "number", isPublic: false, isSecret: false, context: "server" },
    { name: "EFFECT_QUEUE_API_KEY", type: "string", isPublic: false, isSecret: true, context: "server" },
    { name: "EFFECT_QUEUE_TIMEOUT", type: "number", isPublic: false, isSecret: false, context: "server" },
    { name: "EFFECT_PUBSUB_API_KEY", type: "string", isPublic: false, isSecret: true, context: "server" },
    { name: "EFFECT_PUBSUB_TIMEOUT", type: "number", isPublic: false, isSecret: false, context: "server" },

    // Client-safe variables (PUBLIC_ prefix)
    { name: "PUBLIC_API_URL", type: "string", isPublic: true, isSecret: false, context: "client" },
    { name: "PUBLIC_FEATURE_FLAG", type: "boolean", isPublic: true, isSecret: false, context: "client" }
  ]
}
