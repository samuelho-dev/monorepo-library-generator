...
- operation: The operation that failed`,
    fields: [
      { name: "message", type: "string", jsdoc: "Human-readable error message" },
      {
        ...
        type: "unknown",
        optional: true,
        jsdoc: "Optional underlying cause for error chaining"
      },
      {
        name: "correlationId",
        type: "string",
        optional: true,
        jsdoc: "Request/trace correlation identifier"
      },
...
a database transaction cannot be started, committed, or rolled back.`,
    fields: [
      ...
      { name: "operation", type: "string", jsdoc: "Transaction operation that failed" },
      {
        ...
        jsdoc: "Transaction phase that failed"
      },
...
- timestamp: When the error occurred`,
    fields: [
      ...
      { name: "operation", type: "string", jsdoc: "Service operation that failed" },
      {
        ...
        jsdoc: "Error classification code"
      },
      {
        name: "cause",
        type: "unknown",
        optional: true,
        jsdoc: "Underlying error cause for chaining"
      },
      {
        name: "correlationId",
        type: "string",
  ...
  rateLimit: (className: string) => ({
    ...
    fields: [
      { name: "message", type: "string", jsdoc: "Human-readable error message" },
      {
        ...
        type: "number",
        optional: true,
        jsdoc: "Milliseconds until retry is allowed"
      }
    ],
    schemaFields: [
      { name: "message", schema: "Schema.String" },
...
export const ERROR_SETS = {
   ...
   * Domain errors are re-exported from contract.
   */
  feature: (className: string) => [ERROR_DEFINITIONS.service(className)],
...
export function getInfrastructureErrorNames(className: string) {
  return [`${className}ConnectionError`, `${className}TimeoutError`, `${className}TransactionError`]
}
