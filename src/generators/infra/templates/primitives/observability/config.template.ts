/**
 * Observability Configuration Schema Template
 *
 * Generates Effect Schema-based configuration for observability settings.
 * Supports environment variable parsing and validation.
 *
 ...
 */
export function generateObservabilityConfigFile(options: InfraTemplateOptions) {
  ...
  builder.addFileHeader({
    ...
    description: `Effect Schema-based configuration for OpenTelemetry observability.
