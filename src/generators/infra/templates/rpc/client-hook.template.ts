 ...
 *
 * Features:
 * - Effect-native hooks using @effect-atom/atom (renamed from @effect-rx)
 * - No try/catch - errors flow through Effect's typed error channel
 * - Schema-based response/error validation
 * - Full Effect composition (retries, timeouts, tracing)
 *
...
Usage:
  import { useRpcMutation, useRpcQuery, rpcCall } from "${packageName}/client"
