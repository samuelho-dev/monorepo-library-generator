 ...
 */
export const findWorkspaceRoot = (fs: FileSystem.FileSystem, startPath: string) =>
  Effect.gen(function* () {
 ...
 */
export const isWorkspaceRoot = (fs: FileSystem.FileSystem, dirPath: string) =>
  Effect.gen(function* () {
 ...
 */
export const extractScope = (packageName?: string) => {
 ...
 */
export const readScope = (fs: FileSystem.FileSystem, rootPath: string) =>
  Effect.gen(function* () {
 ...
 */
export const detectLibrariesRoot = (fs: FileSystem.FileSystem, rootPath: string) =>
  Effect.gen(function* () {
