...
import type { FilePreview, GeneratorOptions, LibraryType, WorkspaceContext } from "../types"
  ...
  switch (libraryType) {
    ...
    case "domain":
      ...
      return [
        ...
        ...(isNx ? [{ path: `contract/${libraryName}/project.json`, description: "Nx config" }] : []),
        ...
        ...(isNx ? [{ path: `data-access/${libraryName}/project.json`, description: "Nx config" }] : []),
        ...
        { path: `data-access/${libraryName}/src/lib/repository.ts`, description: "Repository impl" },
        { path: `data-access/${libraryName}/src/lib/repository.spec.ts`, description: "Repository tests" },
        ...
        ...(isNx ? [{ path: `feature/${libraryName}/project.json`, description: "Nx config" }] : []),
