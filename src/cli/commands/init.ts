...
const BUILTIN_CONTRACTS: readonly BuiltinContract[] = Object.freeze([
  Object.freeze({
    name: 'auth',
...
const BUILTIN_PROVIDERS: readonly BuiltinProvider[] = Object.freeze([
  Object.freeze({
    name: 'kysely',
...
const BUILTIN_INFRA: readonly BuiltinInfra[] = Object.freeze([
  Object.freeze({
    name: 'env',
