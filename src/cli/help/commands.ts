...
export const contractHelp: EnhancedHelpConfig = {
  description:
    "Generate a contract library with domain types, schemas, and interfaces",
  examples: [
    {
...
export const dataAccessHelp: EnhancedHelpConfig = {
  description:
    "Generate a data-access library with repository and database operations",
  examples: [
    {
...
export const featureHelp: EnhancedHelpConfig = {
  description:
    "Generate a feature library with business logic and server/client support",
  examples: [
    {
...
export const infraHelp: EnhancedHelpConfig = {
  description:
    "Generate an infrastructure library with services and implementations",
  examples: [
    {
...
export const providerHelp: EnhancedHelpConfig = {
  description:
    "Generate a provider library for external service integration",
  examples: [
    {
...
export const domainHelp: EnhancedHelpConfig = {
  description:
    "Generate a complete domain with pre-wired contract, data-access, and feature",
  examples: [
    {
...
export function getCommandHelp(
  ...
  const configs: Record<string, EnhancedHelpConfig> = {
