    ...
    switch (result.libraryType) {
      ...
      case "domain":
        yield* generateDomain({
          ...
          ...(result.options.includeCache !== undefined && { includeCache: result.options.includeCache }),
          ...(result.options.includeClientServer !== undefined && { includeClientServer: result.options.includeClientServer }),
          ...(result.options.includeCQRS !== undefined && { includeCQRS: result.options.includeCQRS }),
          ...(result.options.includeRPC !== undefined && { includeRPC: result.options.includeRPC }),
          ...(result.options.includeEdge !== undefined && { includeEdge: result.options.includeEdge })
        })
        break
    }
