 ...
 */
export function runWizard(librariesRoot: string) {
  return Effect.gen(function*() {
    ...
    yield* Console.log(formatStepProgress("configure-options", needsExternalService))
    yield* Console.log("")
    ...
    yield* Console.log(formatStepProgress("review-confirm", needsExternalService))
    yield* Console.log("")
    ...
    yield* Console.log(`  ${formatTargetDirectory(librariesRoot, libraryType, libraryName)}`)
    yield* Console.log("")
    ...
    // Final confirmation
    const confirmed = yield* confirmGeneration(targetDirectory, fileCounts.total)
