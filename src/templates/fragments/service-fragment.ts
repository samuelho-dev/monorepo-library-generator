 ...
 */
function buildMethodDefinitions(methods: readonly ServiceMethod[], context: TemplateContext) {
  const lines: string[] = []
 ...
 */
function buildParams(params: readonly MethodParam[], context: TemplateContext) {
  return params
    .map((p) => {
 ...
 */
function buildStaticLayers(layers: readonly StaticLayer[], context: TemplateContext) {
