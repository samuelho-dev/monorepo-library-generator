 ...
 */
function buildFieldDefinitions(fields: readonly ErrorField[], context: TemplateContext) {
  const lines: string[] = []
 ...
 */
function buildStaticMethods(methods: readonly ErrorStaticMethod[], context: TemplateContext) {
