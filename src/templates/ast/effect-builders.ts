 ...
 */
export function addEffectImports(sourceFile: SourceFile, items: readonly string[]) {
 ...
 */
export function addTypeImport(sourceFile: SourceFile, from: string, items: readonly string[]) {
  sourceFile.addImportDeclaration({
 ...
 */
export function addImport(sourceFile: SourceFile, from: string, items: readonly string[]) {
  sourceFile.addImportDeclaration({
    moduleSpecifier: from,
    namedImports: [...items]
  })
