 ...
 *
 * Declarative templates for provider library generation.
 * Complete set of 6 template definitions for provider libraries.
 *
 * @module monorepo-library-generator/templates/definitions/provider
 */
