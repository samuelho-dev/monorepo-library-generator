/**
 * Data Access Template Definitions
 *
 * Declarative templates for data-access library generation.
 * Complete set of 7 template definitions for data-access libraries.
 *
 * @module monorepo-library-generator/templates/definitions/data-access
 */
