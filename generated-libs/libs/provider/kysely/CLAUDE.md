...
> AI-optimized reference for Kysely

## Quick Reference

**Purpose**: Kysely provider for Kysely
**Platform**: node
...
// Server exports
import { KyselyLive } from '@custom-repo/provider-kysely/server';
...
```bash
# Build
pnpm exec nx build provider-kysely

# Test
pnpm exec nx test provider-kysely

# Type check
pnpm exec nx typecheck provider-kysely

# Lint
pnpm exec nx lint provider-kysely
```
...
pnpm exec nx build provider-kysely --batch
...
// import { KyselyService } from 'libs/...';
```
