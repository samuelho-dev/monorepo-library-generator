...
export class UserNotFoundError extends Data.TaggedError(
  ...
  static create(id: string): UserNotFoundError {
...
export class UserValidationError extends Data.TaggedError(
  ...
  static create(errors: readonly string[]): UserValidationError {
...
export class UserConflictError extends Data.TaggedError(
  ...
  static create(conflictingId?: string): UserConflictError {
...
export class UserConfigError extends Data.TaggedError(
  ...
  static create(property: string, reason: string): UserConfigError {
...
export class UserConnectionError extends Data.TaggedError(
  ...
  static create(target: string, cause: unknown): UserConnectionError {
...
export class UserTimeoutError extends Data.TaggedError(
  ...
  static create(operation: string, timeoutMs: number): UserTimeoutError {
...
export class UserInternalError extends Data.TaggedError(
  ...
  static create(reason: string, cause: unknown): UserInternalError {
