...
> AI-optimized reference for Env
...
// Server exports
import { EnvLive } from '@custom-repo/infra-env/server';
...
```bash
# Build
pnpm exec nx build infra-env

# Test
pnpm exec nx test infra-env

# Type check
pnpm exec nx typecheck infra-env

# Lint
pnpm exec nx lint infra-env
```
...
pnpm exec nx build infra-env --batch
...
import { EnvService } from '@custom-repo/infra-env/server';

// ❌ Wrong: Path aliases are NOT used
// import { EnvService } from 'libs/...';
```
