# @custom-repo/contract-product

> AI-optimized reference for Product
...
```typescript
// Main exports
import { Product } from '@custom-repo/contract-product';
...
```bash
# Build
pnpm exec nx build contract-product

# Test
pnpm exec nx test contract-product

# Type check
pnpm exec nx typecheck contract-product

# Lint
pnpm exec nx lint contract-product
```
...
pnpm exec nx build contract-product --batch
...
import { ProductService } from '@custom-repo/contract-product/server';
